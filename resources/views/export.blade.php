...
<tr>
    <td>{{ strtoupper(trans('texts.clients')) }}</td>
</tr>
...
<tr>
    <td>{{ strtoupper(trans('texts.credits')) }}</td>
</tr>
...
<tr>
    <td>{{ strtoupper(trans('texts.tasks')) }}</td>
</tr>
...
<tr>
    <td>{{ strtoupper(trans('texts.invoices')) }}</td>
</tr>
...
<tr>
    <td>{{ strtoupper(trans('texts.quotes')) }}</td>
</tr>
...
<tr>
    <td>{{ strtoupper(trans('texts.recurring_invoices')) }}</td>
</tr>
...
<tr>
    <td>{{ strtoupper(trans('texts.payments')) }}</td>
</tr>
...
<tr>
    <td>{{ strtoupper(trans('texts.products')) }}</td>
</tr>
...
<tr>
    <td>{{ strtoupper(trans('texts.expenses')) }}</td>
</tr>
...
<tr>
    <td>{{ strtoupper(trans('texts.vendors')) }}</td>
</tr>
