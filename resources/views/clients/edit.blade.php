...
<div class="row">
					...
					<div role="tabpanel">
						<ul class="nav nav-tabs" role="tablist" style="border: none">
							<li role="presentation" class="active">
								<a href="#billing_address" aria-controls="billing_address" role="tab" data-toggle="tab">{{
									trans('texts.billing_address') }}</a>
							</li>
							<li role="presentation">
								<a href="#shipping_address" aria-controls="shipping_address" role="tab" data-toggle="tab">{{
									trans('texts.shipping_address') }}</a>
							</li>
						</ul>
					</div>
	...
	<script type="text/javascript">
		$(function () {
			...
			if ({
					{
						$client && $client - > hasAddress() ? 'true' : 'false'
					}
				}) {
				$('#copyBillingDiv').show();
			}
			if ({
					{
						$client && $client - > hasAddress(true) ? 'true' : 'false'
					}
				}) {
	...
	<center class="buttons">
		{!! Button::normal(trans('texts.cancel'))->large()->asLinkTo(URL::to('/clients/' . ($client ? $client->public_id :
