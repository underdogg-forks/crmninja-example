    ...
    <div class="row" id="main-row">
        ...
        <div class="col-md-3 amount-col" id="total-invoiced-col">
            <div class="inner">
                ...
                <div class="amount">
                    {{ Utils::formatMoney($client->paid_to_date + $client->balance, $client->currency_id ?:
                    $account->currency_id) }}
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="pull-right">
                {!!
                Button::success(strtoupper(trans("texts.edit_details")))->asLinkTo(URL::to('/client/details'))->withAttributes(['id'
                => 'editDetailsButton']) !!}
