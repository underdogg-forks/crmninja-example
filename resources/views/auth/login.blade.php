...
<div class="container">
    ...
    <div class="row existing-accounts">
        ...
        <div class="col-md-3 col-xs-6">
            <a href="{{ URL::to('auth/' . $provider) }}" class="btn btn-primary btn-lg" title="{{ $provider }}" id="{{ strtolower($provider) }}LoginButton">
    ...
    <div class="row sign-up">
        ...
        <div class="col-md-3 col-xs-12">
            {!!
            Button::primary(trans('texts.sign_up_now'))->asLinkTo(URL::to('/invoice_now?sign_up=true'))->withAttributes(['class'
            => 'blue'])->large()->submit()->block() !!}
        </div>
    </div>
    @endif
</div>
