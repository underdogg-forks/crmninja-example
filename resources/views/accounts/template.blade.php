        ...
        <div class="well" style="padding-bottom:20px">
            <div class="row">
                <div class="col-md-6">
                    ...
                    $field}) !!}
                    {!! Former::populateField('direction_' . $field, $account->account_email_settings->{'direction_' .
                    $field}) !!}
        ...
        <p>&nbsp;
            ...
            <div class="row">
                ...
                <div class="pull-right" style="padding-top:13px;text-align:right">
                    {!! Button::normal(trans('texts.raw'))->withAttributes(['onclick' =>
                    'showRaw("'.$field.'")'])->small() !!}
                    {!! Button::primary(trans('texts.preview'))->withAttributes(['onclick' =>
                    'serverPreview("'.$field.'")'])->small() !!}
                </div>
            </div>
    </div>
</div>
