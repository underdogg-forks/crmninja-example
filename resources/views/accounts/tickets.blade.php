...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title">{!! trans('texts.tickets') !!}</h3>
    </div>
            ...
            <div class="col-md-12">
                ...
                <div role="tabpanel">
                    <ul class="nav nav-tabs" role="tablist" style="border: none">
                        <li role="presentation" class="active"><a href="#defaults" aria-controls="notes" role="tab"
                                data-toggle="tab">{{ trans('texts.defaults') }}</a></li>
                        <li role="presentation"><a href="#domain" aria-controls="terms" role="tab" data-toggle="tab">{{
                                trans('texts.domain') }}</a></li>
                        <li role="presentation"><a href="#attachments" aria-controls="footer" role="tab" data-toggle="tab">{{
                                trans('texts.attachments') }}</a></li>
                        <li role="presentation"><a href="#notifications" aria-controls="footer" role="tab" data-toggle="tab">{{
                                trans('texts.notifications') }}</a></li>
                        <li role="presentation"><a href="#templates" aria-controls="footer" role="tab" data-toggle="tab">{{
                                trans('texts.templates') }}</a></li>
                    </ul>
                    ...
                    <div class="tab-content panel">
                        ...
                        <div role="tabpanel" class="tab-pane" id="domain">
                            <div class="panel-body form-padding-right">
                                ...
                                ->append(Button::info(trans('texts.search'))->withAttributes(['onclick' =>
                                'checkSupportEmail()']))
...
<script>
    ...
    function checkSupportEmail() {
        $.ajax({
            ...
            data: {
                support_email_local_part: $('#support_email_local_part').val()
            },
