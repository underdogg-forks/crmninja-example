        ...
        <div role="tabpanel">
            <ul class="nav nav-tabs" role="tablist" style="border: none">
                <li role="presentation" class="active">
                    <a href="#invoice_number" aria-controls="invoice_number" role="tab" data-toggle="tab">{{
                        trans('texts.invoice_number') }}</a>
                </li>
                <li role="presentation">
                    <a href="#quote_number" aria-controls="quote_number" role="tab" data-toggle="tab">{{
                        trans('texts.quote_number') }}</a>
                </li>
                <li role="presentation">
                    <a href="#client_number" aria-controls="client_number" role="tab" data-toggle="tab">{{
                        trans('texts.client_number') }}</a>
                </li>
                <li role="presentation">
                    <a href="#credit_number" aria-controls="credit_number" role="tab" data-toggle="tab">{{
                        trans('texts.credit_number') }}</a>
                </li>
                <li role="presentation">
                    <a href="#options" aria-controls="options" role="tab" data-toggle="tab">{{ trans('texts.options')
                        }}</a>
                </li>
            </ul>
        </div>
...
<div class="panel panel-default">
    ...
    <div class="panel-body form-padding-right">
        ...
        <div role="tabpanel">
            <ul class="nav nav-tabs" role="tablist" style="border: none">
                <li role="presentation" class="active">
                    <a href="#product_fields" aria-controls="product_fields" role="tab" data-toggle="tab">{{
                        trans('texts.products') }}</a>
                </li>
                <li role="presentation">
                    <a href="#client_fields" aria-controls="client_fields" role="tab" data-toggle="tab">{{
                        trans('texts.clients') }}</a>
                </li>
                <li role="presentation">
                    <a href="#invoice_fields" aria-controls="invoice_fields" role="tab" data-toggle="tab">{{
                        trans('texts.invoices') }}</a>
                </li>
                <li role="presentation">
                    <a href="#task_fields" aria-controls="expense_fields" role="tab" data-toggle="tab">{{
                        trans('texts.tasks') }}</a>
                </li>
                <li role="presentation">
                    <a href="#expense_fields" aria-controls="task_fields" role="tab" data-toggle="tab">{{
                        trans('texts.expenses') }}</a>
                </li>
                <li role="presentation">
                    <a href="#company_fields" aria-controls="company_fields" role="tab" data-toggle="tab">{{
                        trans('texts.company') }}</a>
                </li>
            </ul>
        </div>
        <div class="tab-content">
...
<div class="panel panel-default">
    ...
    <div class="panel-body form-padding-right">
        ...
        <div role="tabpanel">
            <ul class="nav nav-tabs" role="tablist" style="border: none">
                <li role="presentation" class="active">
                    <a href="#invoice_workflow" aria-controls="invoice_workflow" role="tab" data-toggle="tab">{{
                        trans('texts.invoice_workflow') }}</a>
                </li>
                <li role="presentation">
                    <a href="#quote_workflow" aria-controls="quote_workflow" role="tab" data-toggle="tab">{{
                        trans('texts.quote_workflow') }}</a>
                </li>
            </ul>
        </div>
        <div class="tab-content">
...
<div class="panel panel-default">
    ...
    <div class="panel-body" style="min-height:350px">
        ...
        <div role="tabpanel">
            <ul class="nav nav-tabs" role="tablist" style="border: none">
                <li role="presentation" class="active"><a href="#invoice_terms" aria-controls="invoice_terms" role="tab"
                        data-toggle="tab">{{ trans('texts.invoice_terms') }}</a></li>
                <li role="presentation"><a href="#invoice_footer" aria-controls="invoice_footer" role="tab" data-toggle="tab">{{
                        trans('texts.invoice_footer') }}</a></li>
                <li role="presentation"><a href="#quote_terms" aria-controls="quote_terms" role="tab" data-toggle="tab">{{
                        trans('texts.quote_terms') }}</a></li>
