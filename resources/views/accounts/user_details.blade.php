    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body form-padding-right">
                ...
                $oauthProviderName . ' - ' . link_to('#', trans('texts.disable'), ['onclick' =>
                'disableSocialLogin()']) :
    ...
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div style="background-color: #fff" id="changePasswordDiv" onkeyup="validateChangePassword()"
                            onclick="validateChangePassword()" onkeydown="checkForEnter(event)">
                            &nbsp;
            ...
            <div class="modal-footer" id="changePasswordFooter">
                ...
                <button type="button" class="btn btn-success" onclick="submitChangePassword()" id="changePasswordButton"
                    disabled>
                    {{ trans('texts.save') }}
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result == 'success') {
                    ...
                    $('#successDiv').show();
                    $('#cancelChangePasswordButton').html('{{ trans('
                        texts.close ') }}');
                } else {
