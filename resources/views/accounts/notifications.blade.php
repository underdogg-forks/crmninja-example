...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		->label('webhook_url')
		->help(trans('texts.slack_webhook_help', ['link' => link_to('https://my.slack.com/services/new/incoming-webhook/',
		trans('texts.slack_incoming_webhooks'), ['target' => '_blank'])])) !!}
...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		->help(trans('texts.analytics_key_help', ['link' =>
		link_to('https://support.google.com/analytics/answer/1037249?hl=en', 'Google Analytics Ecommerce', ['target' =>
		'_blank'])])) !!}
