...
<script>
    ...
    function loadFont(fontId) {
        ...
        if (!window.ninjaFontVfs[fontFolder]) {
            ...
            jQuery.getScript({!!json_encode(asset('js/vfs_fonts/%s.js')) !!
            }.replace('%s', fontFolder), function () {
...
<div class="row">
    <div class="col-md-12">
        ...
        {!! Former::populateField('background_image_id', $account->background_image ?
        $account->background_image->public_id : null) !!}
            ...
            <div class="panel-body">
                <div role="tabpanel">
                    <ul class="nav nav-tabs" role="tablist" style="border: none">
                        <li role="presentation" class="active"><a href="#general_settings" aria-controls="general_settings"
                                role="tab" data-toggle="tab">{{ trans('texts.general_settings') }}</a></li>
                        ...
                        <li role="presentation"><a href="#invoice_options" aria-controls="invoice_options" role="tab"
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane" id="invoice_fields">
                        <div class="panel-body">
                            <div class="row" id="invoiceFields">
                                @include('accounts.partials.invoice_fields_selector', ['section' => 'invoice_fields',
                                'fields' => INVOICE_FIELDS_INVOICE])
                                @include('accounts.partials.invoice_fields_selector', ['section' => 'client_fields',
                                'fields' => INVOICE_FIELDS_CLIENT])
                                @include('accounts.partials.invoice_fields_selector', ['section' => 'account_fields1',
                                'fields' => INVOICE_FIELDS_ACCOUNT])
                                @include('accounts.partials.invoice_fields_selector', ['section' => 'account_fields2',
                                'fields' => INVOICE_FIELDS_ACCOUNT])
                            </div>
                    ...
                    <div role="tabpanel" class="tab-pane" id="product_fields">
                        <div class="panel-body">
                            <div class="row" id="productFields">
                                @include('accounts.partials.invoice_fields_selector', ['section' => 'product_fields',
                                'fields' => INVOICE_FIELDS_PRODUCT, 'colWidth' => 6])
                                @include('accounts.partials.invoice_fields_selector', ['section' => 'task_fields',
                                'fields' => INVOICE_FIELDS_TASK, 'colWidth' => 6])
                            </div>
                            <div class="row" style="padding-top:30px">
                                <div class="pull-left help-block">
                    ...
                    <div role="tabpanel" class="tab-pane" id="invoice_options">
                        <div class="panel-body">
                            ...
                            '_blank'])])
                            //: trans('texts.enable_proposals_for_background', ['link' =>
                            link_to('/settings/account_management', trans('texts.click_here'), ['target' =>
                            '_blank'])])
                            : 'To upload a background image <a href="http://www.ninja.test/settings/account_management"
                                target="_blank">click here</a> to enable the proposals module.'
                            ) !!}
                            @endif
