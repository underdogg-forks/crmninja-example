...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		<br />
		{!! Former::actions( Button::success(trans('texts.save'))->withAttributes(['id' =>
		'formSave'])->submit()->appendIcon(Icon::create('floppy-disk')) ) !!}
	</div>
</div>
...
<div class="modal fade" id="paymentLimitsModal" tabindex="-1" role="dialog" aria-labelledby="paymentLimitsModalLabel"
 aria-hidden="true">
										...
										<div class="col-md-6">
											<div id="payment-limit-min-container">
												...
												<div class="input-group" style="padding-bottom:8px">
													...
													<input type="number" class="form-control" min="0" id="payment-limit-min" name="limit_min">
												</div>
												<label><input type="checkbox" id="payment-limit-min-enable" name="limit_min_enable"> {{
													trans('texts.enable_min') }}</label>
											</div>
										</div>
										<div class="col-md-6">
											<div id="payment-limit-max-container">
												...
												<div class="input-group" style="padding-bottom:8px">
													<span class="input-group-addon">{{ $currency->symbol }}</span>
													<input type="number" class="form-control" min="0" id="payment-limit-max" name="limit_max">
												</div>
												<label><input type="checkbox" id="payment-limit-max-enable" name="limit_max_enable"> {{
													trans('texts.enable_max') }}</label>
											</div>
										</div>
									</div>
							...
							<div role="tabpanel" class="tab-pane" id="fees">
								...
								<div id="feesEnabled" class="panel-body">
									...
									<div class="help-block">
										...
										@if ($account->gateway_fee_enabled && !$account->invoice_item_taxes && $account->invoice_taxes &&
										count($taxRates))
