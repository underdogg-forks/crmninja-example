    ...
    <div class="modal-dialog">
        <div class="modal-content" style="background-color: #f8f8f8">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="emailModalLabel">{{ trans($invoice->isQuote() ? 'texts.email_quote' :
                    'texts.email_invoice') }}</h4>
            </div>
            ...
            <div class="container" style="width: 100%; padding-bottom: 0px !important">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span title="{{ $activity->present()->createdAt }}">
                                                {{ $activity->present()->createdAtDate }} - {{
                ...
                <div class="modal-footer" style="margin-top: 2px; padding-right:0px">
                    ...
                    <button id="sendEmailButton" type="button" class="btn btn-info" onclick="onConfirmEmailClick()">{{
                        trans('texts.send_email') }}</button>
                </div>
            </div>
        </div>
    </div>
